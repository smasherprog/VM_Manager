...
{
    public class Local_Media_Create_Model : View_Model_To_Service
    {
        ...
        public Local_Media_Create_Model(Libvirt.CS_Objects.Host con, Libvirt.Models.Concrete.Virtual_Machine d)
            : base(con, d)
        {
